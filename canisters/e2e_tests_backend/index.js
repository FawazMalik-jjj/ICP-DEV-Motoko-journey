...
import { idlFactory } from './e2e_tests_backend.did.js';
export { idlFactory } from './e2e_tests_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.E2E_TESTS_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./e2e_tests_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the e2e_tests_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./e2e_tests_backend.did.js")._SERVICE>}
 */
export const e2e_tests_backend = createActor(canisterId);
